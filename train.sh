...
do
    ...
    --seed ${seed} \
    --n_training_threads 12 --n_rollout_threads 12 --num_mini_batch 2 --share_policy \
    --episode_length 500 --num_env_steps 2000000 --ppo_epoch 5 --use_ReLU --gain 1 --lr 1e-4 --entropy_coef 0.01 --critic_lr 3e-4 \
